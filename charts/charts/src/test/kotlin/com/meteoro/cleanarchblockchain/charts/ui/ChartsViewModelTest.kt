...
import com.meteoro.cleanarchblockchain.testutils.TestCoroutineRule
...
class ChartsViewModelTest {
    ...
    @Test
    fun `GIVEN successful result WHEN user opens charts feature THEN show loading and successful response sequencially`() {
